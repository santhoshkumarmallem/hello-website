        ...
        <div className="glass-card rounded-2xl p-8 animate-fade-up animation-delay-100">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 bg-secondary/50 border-border/50 focus:border-accent focus:ring-accent/20 h-11"
                  value={password}
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center transition-colors ${
                          req.met ? "bg-green-400/20" : "bg-secondary"
                        }`}
                      >
            ...
            <div className="flex items-start gap-2">
              <Checkbox
                id="terms"
                className="border-border/50 data-[state=checked]:bg-accent data-[state=checked]:border-accent mt-0.5"
                required
              />
              <Label
                htmlFor="terms"
